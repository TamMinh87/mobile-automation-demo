...
public class JsonConverter {
    ...
    public static <T> T parseJSON(String jsonString) throws ParseException {
        Object responseObject = new JSONParser().parse(jsonString);
        boolean isJSONObject = responseObject instanceof org.json.simple.JSONObject;
        return isJSONObject ? (T) new org.json.JSONObject(jsonString) : (T) new org.json.JSONArray(jsonString);
    }
}
